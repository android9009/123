...
function watermark()
{
    ...
    Render.String( x1 + 247, y1 + 37, 0, " " + datetime, [ 255, 255, 255, 220 ], 3 );
    Render.GradientRect( x1 + 55,  y1 + 25, 240, 3, 1, [colors.g, colors.b, colors.r, 255], [colors.r, colors.g, colors.b, 255]); // rainbow line
...
function main()
{
        ...
        UI.AddSliderInt("Watermark y", 0, screensize[0]);
}
main()
