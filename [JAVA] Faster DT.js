...
const tolerance = menu.call(ui.add_slider_int, "Tolerance", "dt_tolerance", [0, 10]);
const shift = menu.call(ui.add_slider_int, "Shift", "dt_shift", [0, 20]);
...
{
    Exploit.OverrideTolerance(menu.get(tolerance));
    Exploit.OverrideShift(menu.get(shift));
}
