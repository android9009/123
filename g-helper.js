...
function atv(pitch, yaw) {
  ...
  function menu_cb() {
    var enabled = UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Grenade Helper Enable");
    UI.SetEnabled("Misc", "JAVASCRIPT", "Script items", "Automatic Throw", enabled);
    UI.SetEnabled("Misc", "JAVASCRIPT", "Script items", "Automatic Throw Hotkey", enabled);
    UI.SetEnabled("Misc", "JAVASCRIPT", "Script items", "Grenade Helper Color", enabled);
    UI.SetEnabled("Misc", "JAVASCRIPT", "Script items", "Render nade on all map", enabled);
  }
  ...
  if (enabled)
  {
    ...
    for(var i = 0; i < coordslenght; i++) {
      ...
      if(weaponnames[crd[2]].indexOf(weapon) >= 0) {
        ...
        var nadeallmap = UI.GetValue("Misc", "JAVASCRIPT", "Script items","Render nade on all map");
