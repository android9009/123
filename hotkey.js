...
function keybinds()
{
     ...
     if (UI.IsHotkeyActive("Rage", "Exploits", "Double tap  [toggled]")) {
       h.push("Double tap  [toggled]")
     }   
     ...
     Render.FilledRect(x, y, 200, 23, [0, 0, 0, 30]);
     Render.String(x + 5, y + 5, 0, "Hotkeys", [255, 255, 255, 255], 8);
     Render.Line(x, y + 20, x + 200, y + 20, [45,121,202, 255]);
     
     Render.FilledRect(x, y + 22, 200, 20 + 15 * (h.length - 1), [0, 0, 0, 20]);
