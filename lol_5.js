var _0x2d2d = ['GetScreenSize', 'IsHotkeyActive', 'Misc', 'Script items', 'JAVASCRIPT', 'push', 'sharkhvh', 'SCOUT', 'GetValue', 'Rage', 'Minimum damage', 'AUTOSNIPER', 'Rage Anti-Aim', 'indexOf', 'GetUsername', 'Anti-Aim', 'Yaw offset', 'Jitter offset', 'SetRealOffset', 'SetOverride', 'toUpperCase', 'Exploits', 'g3sg1', 'CFlashbang', 'CSmokeGrenade', 'CDecoyGrenade', 'Fake angles', 'AWP', 'ssg 08', 'Line', 'abs', 'toFixed', 'min', 'GetFakeYaw', 'Selected arrow color', 'GetColor', '[exscord] Freestanding', 'GetClassName', 'EXSCORD', 'SetValue', '[exscord] Hide real', 'DYNAMIC', 'FREESTAND', 'StringCustom', 'DEFAULT', 'dual berettas', 'usp s', 'CHEGrenade', 'CIncendiaryGrenade', 'CC4', 'DT (onshot)', 'DT (active weapon)', 'DMG', 'SAFE', 'HEAD', 'Backwards Hotkey', 'Tickcount', 'CWeaponAWP', 'GENERAL', 'Force safe point', '          Last update: 19/09/20', 'Left Hotkey', 'AddHotkey', 'AddColorPicker', 'AddCheckbox', '[exscord] Safe AWP', 'Minimum damage override', 'AddSliderInt', 'CreateMove', 'Safe_Head'];
...
var _0x3a0e6d = _0x24ed,
    ...
    drawRight = 0x0,
    prefer_safe_backup = ![];
protectnames[_0x3a0e6d('0x5')]('kitty'), protectnames['push']('w1ne'), protectnames['push']('dredoff'), protectnames['push']('starkow'), protectnames['push']('Rusboy18'), protectnames['push']('Bernie16'), protectnames['push']('zilibobka228'), protectnames['push']('mish'), protectnames[_0x3a0e6d('0x5')](_0x3a0e6d('0x6')), protectnames['push']('Mosilen'), protectnames[_0x3a0e6d('0x5')]('u think u r good?');
