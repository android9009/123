...
function HUD_REDRAW()
{
    ...
    if(loadFont == 0)
    {
        font = Render.AddFont("trebuchet ms", 8, 100)
        fontSmall = Render.AddFont("trebuchet ms", 6, 100)
        fontNormal = Render.AddFont("trebuchet ms", 7, 100)
        loadFont = 1;
    }
     
    var watermark_font = Render.AddFont("trebuchet ms", 8, 100)
    ...
    var width = 197
    //grey all
    Render.FilledRect( x + 45, y , width, height+11, [ 23, 18, 50, 255 ] );
   
    //main
    Render.FilledRect( x + 50, y + 7, width-11, height-1 , [ 33, 26, 68, 255 ] ); // black
 
    //white
    Render.Rect( x + 50, y + 5, width-10, height+2, [ 46, 40, 76, 255 ] ); // white
    width = 93
    Render.GradientRect(x + 50, y + 5, width, 1, 1, [ 175, 35, 100 ,255], [75, 14, 50 ,255]);
    Render.GradientRect(x + 50 + width, y + 5, width, 1, 1, [75, 14, 50 ,255], [56, 44, 116, 255]);
    ...
    if(fakelag > 16)
        fakelag = 16
    //Fakelag
    Render.StringCustom(x + 81, y + 7, 1, "Fake lag", [ 255, 255, 255,255 ], font);
 
    //grey inactive
    Render.FilledRect(x + 130, y + 16, 100, 5, [ 50, 50, 50, 255 ]);
 
    //CALCULATOR: 100/16
    Render.GradientRect( x + 130, y + 16, fakelag*6.25, 5, 0, [ 175, 35, 100 ,255 ], [ 0, 0, 0, 50 ]);
    ...
    //Yaw
    Render.StringCustom(x + 85, y + 21, 1, "Jitter Yaw", [ 255, 255, 255,255 ], font);
    ...
    if(yawOffset > 0)
    {
        Render.GradientRect( x + 130, y + 30, yawOffset*0.55, 5, 0, [ 175, 35, 100 ,255 ], [ 0, 0, 0, 50 ]);
    ...
    //Yaw
    Render.StringCustom(x + 85, y + 34, 1, "Base Yaw", [ 255, 255, 255,255 ], font);

    //grey inactive
    Render.FilledRect(x + 130, y + 43, 100, 5, [ 50, 50, 50, 255 ]);
    ...
    if(yawOffset > 0)
    {
        Render.GradientRect( x + 130, y + 43, yawOffset*0.55, 5, 0, [ 175, 35, 100 ,255 ], [ 0, 0, 0, 50 ]);
     
        //Little font
        Render.StringCustom(x + 130 + yawOffset*0.55, y + 43, 1, "" + yawOffset, [ 255, 255, 255,255 ], fontSmall);    
    }
    else if(yawOffset < 1)
    {
        Render.GradientRect( x + 130, y + 45, -yawOffset*0.55, 5, 0, [ 175, 35, 100 ,255 ], [ 0, 0, 0, 50 ]);
    ...
    //DT
    if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Doubletap"))
        Render.StringCustom(x + 87, y + 75, 1, "Double tap", [ 255, 255, 255,255 ], font);

    //ON/OFF
    if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Doubletap"))
        Render.StringCustom(x + 200, y + 75, 1, "[Offensive]", [ 175, 35, 100 ,255 ], font);
    ...
    //Fakeduck
    if(UI.IsHotkeyActive("Anti-Aim", "Extra", "Fake duck"))
    Render.StringCustom(x + 86, y + 102, 1, "Fake duck", [ 255, 255, 255,255 ], font);
 
    //Fakeducking state
    if(UI.IsHotkeyActive("Anti-Aim", "Extra", "Fake duck"))
        Render.StringCustom(x + 218, y + 102, 1, "[On]", [ 175, 35, 100 ,255 ], font);
    if(!UI.IsHotkeyActive("Anti-Aim", "Extra", "Fake duck"))
        y -= 14
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Hideshots
    if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Hide shots"))
        Render.StringCustom(x + 87, y + 116, 1, "Hide shots", [ 255, 255, 255,255 ], font);
 
    //Hideshots state
    if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Hide shots"))
        Render.StringCustom(x + 218, y + 116, 1, "[On]", [ 175, 35, 100 ,255 ], font);
    if(!UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Hide shots"))
        y -= 14
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Safe point
    if(UI.IsHotkeyActive("Rage", "GENERAL", "General", "Force safe point"))
        Render.StringCustom(x + 86, y + 129, 1, "Safe point", [ 255, 255, 255,255 ], font);
 
    //Safepoint state
    if(UI.IsHotkeyActive("Rage", "GENERAL", "General", "Force safe point"))
        Render.StringCustom(x + 218, y + 129, 1, "[On]", [ 175, 35, 100 ,255 ], font);
    if(!UI.IsHotkeyActive("Rage", "GENERAL", "General", "Force safe point"))
        y -= 14
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
