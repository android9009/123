...
var modules = {
    ...
    hotkeys: [
        ...
        {path: ["Rage", "GENERAL", "Force safe point"], conditions: [["Rage", "GENERAL", "Enabled"]], label: "force safe point"},
        {path: ["Rage", "GENERAL", "Resolver override"], conditions: [["Rage", "GENERAL", "Enabled"]], label: "resolver override"},
        {path: ["Rage", "GENERAL", "Force body aim"], conditions: [["Rage", "GENERAL", "Enabled"]], label: "force body aim"},
...
/*private function*/ modules.keybinds = function( font )
{
    ...
    draw_container(x, y, 200, "hotkey list", font, accent);
