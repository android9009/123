...
function waterdraw() {
    ...
    var text = "booberhook | Admin | delay: " +Math.round(Entity.GetProp(Entity.GetLocalPlayer(), "CPlayerResource", "m_iPing")).toString()+ "ms | " +Globals.Tickrate().toString()+ "tick | " + hours + minutes + seconds;
    var h = 18;
    ...
    Render.FilledRect(x, y + 2, w, h, [15, 15, 15, 0]);
